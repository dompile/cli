/**
 * Bun Development Server for Unify CLI
 * Uses Bun.serve for high-performance HTTP serving with native routing
 */
...
export class BunDevServer {
  ...
  async start(options = {}) {
    ...
    try {
      ...
      logger.error('Failed to start Bun development server:', error.message);
      throw error;
    }
  }
