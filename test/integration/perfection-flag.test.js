...
describe('--perfection Flag', () => {
  ...
  describe('Successful builds with --perfection', () => {
    it('should complete successfully when all files process correctly (no layouts)', async () => {
      const structure = {
        ...
        'src/about.html': '<!DOCTYPE html><html><body><h1>About</h1></body></html>',
    ...
    it('should handle explicit layouts successfully with --perfection', async () => {
      const structure = {
        ...
        'src/.layouts/main.html': '<!DOCTYPE html><html><body><slot></slot></body></html>',
        'src/about.md': '---\nlayout: main.html\n---\n# About\n\nAbout page'
      };
  ...
  describe('Failed builds with --perfection', () => {
    it('should fail entire build when include file is missing', async () => {
      const structure = {
        ...
        'src/good.html': '<!DOCTYPE html><html><body><h1>This file is fine</h1></body></html>'
      };
      ...
      expect(result.stderr.includes('Include') || result.stderr.includes('missing')).toBeTruthy();
    });

    it('should fail when explicit layout file is missing', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/broken.html': '<div data-layout="missing.html"><h1>Broken</h1></div>',
        'src/good.html': '<!DOCTYPE html><html><body><h1>Good</h1></body></html>'
      };
      ...
      expect(result.code).toBe(1);
      expect(result.stderr.includes('Layout not found') || 
             result.stderr.includes('missing.html')).toBeTruthy();
    });
    ...
    it('should fail when DOM include element is missing', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/broken.html': '<include src="missing.html"></include><h1>Content</h1>',
        'src/good.html': '<!DOCTYPE html><html><body><h1>Good</h1></body></html>'
      };
      ...
      expect(result.code).toBe(1);
      expect(result.stderr.includes('Include') && result.stderr.includes('not found')).toBeTruthy();
    });

    it('should fail on circular include dependencies', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/circular1.html': '<!--#include file="circular2.html" --><p>Circular 1</p>',
        'src/circular2.html': '<!--#include file="circular1.html" --><p>Circular 2</p>',
        'src/good.html': '<!DOCTYPE html><html><body><h1>Good</h1></body></html>'
      };
    ...
    it('should fail when layout has syntax errors in perfection mode', async () => {
      const structure = {
        'src/index.html': '<div data-layout="broken.html"><h1>Content</h1></div>',
        'src/.layouts/broken.html': '<!DOCTYPE html><html><body><unclosed-tag><slot></slot></body></html>',
        'src/good.html': '<!DOCTYPE html><html><body><h1>Good</h1></body></html>'
      };
  ...
  describe('Interaction with other flags', () => {
    it('should work with --clean flag', async () => {
      ...
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>New content</h1></body></html>'
      };
...
<body>
  ...
  describe('Edge cases and complex scenarios', () => {
    it('should fail gracefully with multiple error types in perfection mode', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/bad1.html': '<!--#include file="missing1.html" --><p>Bad include</p>',
        'src/bad2.html': '<div data-layout="missing2.html"><h1>Bad layout</h1></div>',
        'src/bad3.md': '---\ninvalid: yaml: [\n---\n# Bad YAML'
      };
    ...
    it('should handle nested include failures in perfection mode', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/parent.html': '<!--#include file="includes/child.html" --><p>Parent</p>',
        'src/includes/child.html': '<!--#include file="missing-nested.html" --><p>Child</p>',
        'src/good.html': '<!DOCTYPE html><html><body><h1>Good</h1></body></html>'
      };
      ...
      expect(result.stderr.includes('child.html') || result.stderr.includes('missing-nested.html')).toBeTruthy();
    });

    it('should handle absolute path includes in perfection mode', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/test.html': '<!--#include virtual="/includes/absolute.html" --><p>Test</p>',
    ...
    it('should fail on mixed include syntax errors in perfection mode', async () => {
      const structure = {
        'src/index.html': '<!DOCTYPE html><html><body><h1>Home</h1></body></html>',
        'src/mixed.html': '<!--#include file="good.html" --><include src="missing.html"></include>',
        'src/good.html': '<!DOCTYPE html><html><body><p>Good include</p></body></html>'
      };
    ...
    it('should handle layout hierarchy failures in perfection mode', async () => {
      const structure = {
        'src/index.html': '<div data-layout="parent.html"><h1>Content</h1></div>',
        'src/.layouts/parent.html': '<div data-layout="missing-grandparent.html"><slot></slot></div>',
        'src/good.html': '<!DOCTYPE html><html><body><h1>Good</h1></body></html>'
      };
